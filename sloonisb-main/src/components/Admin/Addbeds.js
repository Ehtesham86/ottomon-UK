...
const AddAccessories = () => {
  ...
  let handleSubmit = async (e) => {
    ...
    try {
      ...
      formdata.append("name", "Small Single Beds(2' 6'')");
      formdata.append("price", '78');
      formdata.append("description", "This is the ing  Small Single Beds(2' 6'') mattresses description");
      formdata.append("countInStock", '23');
      formdata.append("Shopby", "Size");
      formdata.append("type","Small Single Beds(2' 6'')");
      formdata.append("Discount",'20');
      formdata.append("actualPrice", '89');
      ...
      fetch("http://localhost:5000/beds", requestOptions)
        .then((response) => {
          response.text()
  ...
  return (<>
    ...
    <h2 className="text-center">Add Beds Form</h2>
