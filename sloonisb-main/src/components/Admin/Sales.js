...
const AddSales = () => {
  ...
  let handleSubmit = async (e) => {
    ...
    try {
      ...
      formdata.append("name", "Clearance Bundles");
      formdata.append("price", '25');
      formdata.append("description", "This is the ing  Clearance Bundles mattresses description");
      formdata.append("countInStock", '23');
      formdata.append("Shopby", "Clearance");
      formdata.append("type","Clearance Bundles");
      formdata.append("Discount",'20');
      formdata.append("actualPrice", '35');
      ...
      fetch("http://localhost:5000/sales", requestOptions)
        .then((response) => {
          response.text()
  ...
  return (<>
    ...
    <h2 className="text-center">Add Sales Form</h2>
